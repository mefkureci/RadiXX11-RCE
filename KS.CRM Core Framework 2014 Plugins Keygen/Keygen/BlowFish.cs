...
namespace Keygen
{
    internal class BlowFish
    {
        ...
        internal byte[] Decrypt_CBC(byte[] ct)
        {
            return this.Crypt_CBC(ct, true);
        }

        internal string Decrypt_ECB(string ct)
        {
        ...
        internal string Encrypt_CBC(string pt)
        {
            if (!this.IVSet)
            {
                this.SetRandomIV();
